...
// Получение массива из кнопок сортировки (треугольников)
...
// Запись требуемых свойств каждого объекта из json в массив arr
...
// Вывод массива на текущую страницу таблицы
...
// Сортировка выбранного столбца по клику на button.triangle
...
// Переворачивание кнопок-треугольников при клике, демонстрация текущего отсортированного столбца
...
// Запись отредактированного элемента в исходный массив
function edit() {
    let textarea = document.getElementById("input");
...
// Обработка клика перехода на предыдущую/следующюю страницу, удаление блока на крайней странице
...
// Сокрытие/показ выбранного столбца
